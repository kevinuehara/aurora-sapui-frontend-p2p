sap.ui.require([
  ...
  var sViewName = "aurora.fiori.app.p2p.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of aurora.fiori.app.p2p"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title aurora.fiori.app.p2p"
            });
        }
      }
